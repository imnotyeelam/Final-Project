...
public class Level3PlayerHealthController1 : MonoBehaviour//IDamageable
{
    public static Level3PlayerHealthController1 instance;
    ...
    private IEnumerator RespawnAfterDelay()
    {
        ...
        // 禁用控制器
        if (Level3PlayerController1.instance != null)
            Level3PlayerController1.instance.GetComponent<CharacterController>().enabled = false;
        ...
        if (PlayerPrefs.HasKey(cpKey))
        {
            ...
            if (L3CheckpointManager.checkpointDict.TryGetValue(checkpointName, out Transform checkpointTransform))
            {
        ...
        // 启用控制器
        if (Level3PlayerController1.instance != null)
            Level3PlayerController1.instance.GetComponent<CharacterController>().enabled = true;
